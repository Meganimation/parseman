...
background: ${(props) => (props.id % 2 === 0) ? 'gray' : 'darkGray'};
...
export default function LogtailComponent(props: LogtailComponentProps) {
    ...
    const tempData = [
        {id: 1, result: '2809-2733097930409-3-02- 2-38832- 2-83382- 2-80230-20932 3-2-293939 32-80230-20932 3- 2-2939393 2-80230-20932 3 -2-29393932-80230-20932 3-2-2939393'},
        ...
        {id: 3, result: '2809-2733097930409-3-02- 2-38832- 2-83382- 2-80230-20932 3-2-293939 32-80230-20932 3- 2-2939393 2-80230-20932 3 -2-29393932-80230-20932 3-2-2939393'},
